...
public class EngineerPlayableClass extends PlayableClass {
    ...
    static {
        ...
        items.put(1, new ItemBuilder(XMaterial.BOW.parseItem()).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
        ...
        items.put(4, new ItemBuilder(XMaterial.STONE_PICKAXE.parseItem()).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
