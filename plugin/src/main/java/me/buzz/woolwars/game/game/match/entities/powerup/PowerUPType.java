...
public enum PowerUPType {
    ...
    STONE_PICKAXE(LanguageFile.STONE_PICKAXE_POWERUP, player -> {
        ...
        if (!hasItem) {
            if (slot != 99) {
                player.getInventory().setItem(slot, new ItemBuilder(material).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
            } else {
                player.getInventory().addItem(new ItemBuilder(material).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
            }
        }
    }, armorStand -> {
    ...
    CHAINMAIL_HELMET(LanguageFile.CHAINMAIL_HELMET_POWERUP, player -> {
        ...
        if (!hasItem)
            player.getInventory().setHelmet(new ItemBuilder(XMaterial.CHAINMAIL_HELMET.parseItem()).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
    ...
    CHAINMAIL_CHESTPLATE(LanguageFile.CHAINMAIL_CHESTPLATE_POWERUP, player -> {
        ...
        if (!hasItem)
            player.getInventory().setChestplate(new ItemBuilder(XMaterial.CHAINMAIL_CHESTPLATE.parseItem()).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
    }, armorStand -> {
    ...
    CHAINMAIL_BOOTS(LanguageFile.CHAINMAIL_BOOTS_POWERUP, player -> {
        ...
        if (!hasItem)
            player.getInventory().setBoots(new ItemBuilder(XMaterial.CHAINMAIL_BOOTS.parseItem()).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
    }, armorStand -> {
    ...
    IRON_BOOTS(LanguageFile.IRON_BOOTS_POWERUP, player -> {
        ...
        if (!hasItem)
            player.getInventory().setBoots(new ItemBuilder(XMaterial.IRON_BOOTS.parseItem()).addItemFlags(ItemFlag.HIDE_UNBREAKABLE).unbreakable(true).build());
    }, armorStand -> {
