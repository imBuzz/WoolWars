...
public class PlayableArena extends ArenaMetadata implements ApiPlayableArena {
    ...
    public PlayableArena(ArenaMetadata metadata, World world) {
        super(metadata.ID, metadata.name, metadata.matchType, metadata.maxPlayers, metadata.powerups, metadata.locations, metadata.regions, metadata.presets, metadata.getWorldName());
        this.world = world;
