...
public class TankPlayableClass extends PlayableClass {
    ...
    static {
        ...
        items.put(3, new ItemBuilder(Material.WOOL).amount(64).build());
    ...
    public void equip(WoolPlayer woolPlayer, MatchStats stats) {
        ...
        armor.forEach((slot, item) -> player.getInventory().setItem(slot.getSlot(), PlayableClass.adjustItem(teamColor, item.clone())));
